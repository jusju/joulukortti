...
class henkiloPDO {
	...
	function __construct($dsn = "mysql:host=localhost;dbname=henkilot", $user = "root", $password = "WlUDzpdt8z") {
		// Ota yhteys kantaan
	...
	public function kaikkiHenkilot() {
		$sql = "SELECT id, etunimi, sukunimi, lahiosoite, postinumero, postitoimipaikka, puhelin, palkka, alku, lisatieto FROM henkilo";
